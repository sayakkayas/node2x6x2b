...
void* doSomeThing()
{
  ...
  if(pthread_equal(threads[2],pthread_self()))
    ...
    {  
         ...
         while(1)
         {   
             if(counter1[0]>=MAX &&  counter2[0]>=MAX && counter3[0]>=MAX )
               break;
             ...
             if(counter3[0]%3==0 && counter3[0]< MAX)
             { //atomic_fetch_add((args->counter_ptr),1);
    ...
    {  
         ...
         while(1)
         {   
             if(  counter2[0]>=MAX && counter3[0]>=MAX )
               break;

             


             if(counter2[0]%2==1 && counter2[0]< MAX)
             { //atomic_fetch_add((args->counter_ptr),1);
             ...
             if(counter3[0]%2==1 && counter3[0]< MAX)
             { //atomic_fetch_add((args->counter_ptr),1);
