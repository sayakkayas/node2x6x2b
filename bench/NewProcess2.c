 ...
 int  shm_id;        /* shared memory ID      */
   ...
   */
   // sleep(1);
    ...
    //mem=7;
     printf("PID %d Virtual address of shm_at->ar[0] is %p\n",pid,&(shm_at->ar[0][0]));
     printf("PID %d Virtual address of shm_at->ar[1] is %p\n",pid,&(shm_at->ar[1][0]));
     printf("PID %d Virtual address of shm_at->ar[2] is %p\n",pid,&(shm_at->ar[2][0]));
     printf("PID %d Virtual address of shm_at->ar[3] is %p\n",pid,&(shm_at->ar[3][0]));
   //   printf("PID %d Virtual address of shm_at->lock is %p\n",pid,&(shm_at->lock));
    ...
    /*
      ...
      printf("PID %d Val shm_at[0][0] %d\n",pid,shm_at->ar[0][0]);
      printf("PID %d Val shm_at[1][0] %d\n",pid,shm_at->ar[1][0]);
      printf("PID %d Val shm_at[2][0] %d\n",pid,shm_at->ar[2][0]);
      printf("PID %d Val shm_at[3][0] %d\n",pid,shm_at->ar[3][0]);
